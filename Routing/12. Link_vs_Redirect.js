LINK
when we link page, then it changes URL in the address bar. 
it pushes new URL in the history API, so if we click back button then we can go to the previous page.
